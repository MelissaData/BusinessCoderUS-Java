...
# Business Coder API JAVA REST Sample Code

This is a sample code for Melissa's Business Coder API. It is written in JAVA and accesses the API through REST. 
This sample is intended to show the functionality of the Business Coder Web Service and how to call the service in JAVA. 
